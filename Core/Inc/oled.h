...
#define OLED_SCL_Clr() HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3, GPIO_PIN_RESET) //SDL
...
#define OLED_RES_Clr() HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_RESET)//RES
...
extern uint8_t  oled_buffer[100];
