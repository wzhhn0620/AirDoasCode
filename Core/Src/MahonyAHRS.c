...
#define twoKiDef	(1.0f * 0.5f)	// 2 * integral gain
...
volatile float q0 = 1.0f, q1 = 0.0f, q2 = 0.0f, q3 = 0.0f;	// quaternion of sensor frame relative to auxiliary frame
volatile fp32 pitch = 0.0f, roll = 0.0f, yaw = 0.0f;
...
void M_get_angle(float q0, float q1, float q2, float q3, fp32 *yaw, fp32 *pitch, fp32 *roll){
